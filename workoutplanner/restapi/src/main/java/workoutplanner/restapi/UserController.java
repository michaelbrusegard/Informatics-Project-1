...
public class UserController {
  ...
  /**
   * Local ObjectMapper variable, used for serializing objects that are sent
   * from the backend or received from the frontend.
   */
  ...
  /**
   * Local boolean variable, used for determining whether to log the objects
   * sent with each endpoint or not.
   */
   ...
   * to the user object, logs the endpoint and optionally the result, and
   * returns the list
   * of workout names.
   * </p>
   *
   ...
   * the user object, logs the endpoint and optionally the result, and returns
   * the list
   * of exercises.
   * </p>
   *
  ...
  public ResponseEntity<String> deleteUnsavedWorkouts() {
    ResponseEntity<String> response =
            ResponseEntity.ok("Unsaved workouts deleted successfully.");
