...
public class OverviewControllerTest extends FxTest{
    ...
    public void testSaveButton(){
        ...
        clickOn("#save");
        clickOn("#alertButton");
        Button editButton = (Button) ((HBox)((VBox)((GridPane)((ScrollPane) lookup("#scrollPane").query()).getContent()).getChildren().get(1)).getChildren().get(2)).getChildren().get(0);
        clickOn(editButton);
    ...
    private void checkExistingWorkouts(){
        ...
        boolean empty = true;
        while (empty) {
            System.out.println((((VBox) ((GridPane) ((ScrollPane) lookup("#scrollPaneWorkout").query()).getContent()).getChildren().get(1)).getChildren()));
            System.out.println(((VBox)((VBox) ((GridPane) ((ScrollPane) lookup("#scrollPaneWorkout").query()).getContent()).getChildren().get(1)).getChildren().get(1)).getChildren());
            System.out.println((((VBox) ((GridPane) ((ScrollPane) lookup("#scrollPaneWorkout").query()).getContent()).getChildren().get(1)).getChildren().get(0)));
            boolean vbox = ((GridPane) ((ScrollPane) lookup("#scrollPaneWorkout").query()).getContent()).getChildren().get(0) instanceof VBox;
            if (!vbox) {
                Text text = (Text)((VBox)((GridPane) ((ScrollPane) lookup("#scrollPane").query()).getContent()).getChildren().get(1)).getChildren().get(0);
                Button deleteButton = (Button) ((HBox) ((VBox) ((GridPane) ((ScrollPane) lookup("#scrollPane").query()).getContent()).getChildren().get(1)).getChildren().get(2)).getChildren().get(1);
                clickOn(deleteButton.getId());
